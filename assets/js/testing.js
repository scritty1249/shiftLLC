/* This file will contain the tools used in website testing. */

// Color Wheel
var colorPicker;
var initPicker = false;
$(document).ready(function () {
    // Adding div for the picker wheel
    $("#content").prepend(
        $(document.createElement("div"))
            .attr({ id: "dev-insert" })
            .css({
                position: "fixed",
                zIndex: 9, // Change this if there are clicking conflicts
                top: "20px",
                overflow: "hidden",
                "border-radius": "15px",
                ...
                $(document.createElement("div"))
                    ...
                    .append(
                        $(document.createElement("div")).attr({
                            id: "picker",
                            class: "dev-color-wheel",
                        })
                    )
            )
            // Adding div for the toggle arrow
            .prepend(
                $(document.createElement("div"))
                    .attr({ id: "dev-toggle" })
                    .css({
                    ...
                    .click(function () {
                        ...
                        if ($("#dev-menu").css("visibility") != "visible") {
                            $("#dev-menu").css({
                                visibility: "visible",
                                width: "250px",
                            });
...
function setupColorPicker() {
    ...
    $("#picker").find("*").addClass("dev-color-wheel");

    // Adding button box
    $("#dev-menu").append(
        $(document.createElement("div")).attr({ id: "dev-menu-buttons" }).css({
            width: "100%",
        })
    );
    // Adding buttons
    $("#dev-menu-buttons").append(
        $(document.createElement("div"))
            .text("Set to text")
            .css({
                height: "1.5em",
            ...
            .click(function () {
                $("#content")
                    ...
                    .not("[id*='dev-']")
                    .not("[class*='dev-']")
                    .css("color", colorPicker.color.hexString);

                $("#content")
                    .find("*:not(:has([class*='dev-']))")
                    .find("*:not(:has([id*='dev-']))")
                    .css("border-color", colorPicker.color.hexString);
            })
    );
    ...
    $("#dev-menu-buttons").append(
        $(document.createElement("div"))
            ...
            .click(function () {
                ...
                $("body").css({ backgroundColor: colorPicker.color.hexString });
                $("#navbar").css({
                    backgroundColor: colorPicker.color.hexString,
                });
            })
    );
    ...
    $("#dev-menu-buttons").append(
        $(document.createElement("div"))
            ...
            .click(function () {
                $("*[og-style]").each(function () {
                    $(this).attr("style", $(this).attr("og-style"));
                });
    ...
    // Styling all buttons
    $("#dev-menu-buttons").children().addClass("dev-menu-button").css({
        backgroundColor: "rgba(0.1, 0.1, 0.1, 0.5)",
        "border-radius": "5px",
    ...
    $("#content")
        ...
        .each(function () {
            if ($(this).attr("style")) {
                $(this).attr("og-style", $(this).attr("style"));
            } else {
                $(this).attr("og-style", "");
            }
        });
    ...
    !(function (t, n) {
        ...
        function R(t, n, i, r, e) {
            ...
            if (
                ...
                if (((u = t.style), "string" == typeof i)) u.cssText = i;
                    ...
                    if (
                        ("string" == typeof r && ((u.cssText = ""), (r = null)),
                        r)
                    )
                ...
                t: if ("function" == typeof k) {
                    ...
                    n.o = (function (t, n, i, r, e, u, o, l) {
                        ...
                        return (
                            null === n.type
                                ? h !== v &&
                                  (null != u && (u[u.indexOf(t)] = null),
                                  (t.data = v))
                                : n !== i &&
                                  (null != u &&
                                      (u = j.slice.call(t.childNodes)),
                                  (a = (h = i.props || x)
        ...
        (m = {}),
            (I.prototype.setState = function (t, n) {
                var i =
                    (this.j !== this.state && this.j) ||
                    (this.j = M({}, this.state));
                ("function" == typeof t && !(t = t(i, this.props))) || M(i, t),
                    null != t &&
                        this.d &&
                        ((this.u = !1), n && this.m.push(n), e(this));
            }),
                    ...
                    if ((r = n.c) && !r.i)
                        try {
                            if (
                                ...
                                r.setState(
                                    r.constructor.getDerivedStateFromError(t)
                                );
                            else {
            ...
            gt = (function (n) {
                ...
                return (
                    ...
                    (((t.prototype = Object.create(
                        n && n.prototype
                    )).constructor = t).prototype.render = function (t) {
                ...
                Object.assign({}, e, {
                    onInput: function (t, n, i) {
                        if (0 === i) {
                            ...
                            1 === i &&
                                ((s.inputActive = !0), (c.hsv = ct(e, t, n)));
                        e.onInput(i, e.id);
                    },
                }),
                function (t, n, i) {
                ...
                Object.assign({}, e, {
                    onInput: function (t, n, i) {
                        if (0 === i) {
                            ...
                            1 === i &&
                                ((o.inputActive = !0), (l.hsv = lt(e, t, n)));
                        e.onInput(i, e.id);
                    },
                }),
                function (t, n, i) {
        ...
        var kt = (function (i) {
            ...
            return (
                ...
                (t.prototype.emit = function (t) {
                    for (
                        var n = this, i = [], r = arguments.length - 1;
                        0 < r--;
